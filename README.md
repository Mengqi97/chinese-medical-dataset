...
1、[寻医问药网站]( https://jib.xywy.com/) 

2、[2020CHIP-中文医学文本实体关系抽]( https://github.com/TingFree/NLPer-Arsenal/blob/master/%E5%BE%80%E6%9C%9F%E7%AB%9E%E8%B5%9B/%E4%BF%A1%E6%81%AF%E6%8A%BD%E5%8F%96/2020CHIP-%E4%B8%AD%E6%96%87%E5%8C%BB%E5%AD%A6%E6%96%87%E6%9C%AC%E5%AE%9E%E4%BD%93%E5%85%B3%E7%B3%BB%E6%8A%BD%E5%8F%96.md)
...
1. [Mac电脑如何安装并启用neo4j进行知识图谱的构建](https://blog.csdn.net/Jinman_Wu/article/details/136130975?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_baidulandingword~default-0-136130975-blog-128326536.235^v43^pc_blog_bottom_relevance_base9&spm=1001.2101.3001.4242.1&utm_relevant_index=3)
2. [java 官方下载链接](https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html)
...
2. 安装neo4j：从 [Neo4i Server下载](https://neo4j.com/deployment-center/#enterprise) 这个网址中，下载neo4j压缩包。找到Graph Database Self-Managed模块，选择"COMMUNITY", 选择"Neo4j 4.4.36 Released 23 July 2024"。因为我是mac本，因此我选择了"Linux / Mac Executable Neo4i 4.4.36 （tar）"。然后就可以获得一个压缩包 [neo4j-community-4.4.36-unix.tar.gz](https://dist.neo4j.org/neo4j-community-4.4.36-unix.tar.gz) 。将该压缩包解压并，将该文件夹下的bin文件夹的绝对目录添加到系统变量中。

3. 运行neo4j：本地terminal中运行`neo4j start`
     ```python
...
6. 启动neo4j，并用本地浏览器访问：本地terminal中运行`neo4j start  `，本地浏览器中输入网址  http://localhost:7474。随后可以输入各种查询指令进行使用，比如我用如下指令将知识图谱的部分数据进行可视化，由于内存限制等原因无法展示全部知识图谱。
